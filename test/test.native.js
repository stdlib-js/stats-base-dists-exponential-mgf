...
tape( 'if provided a nonpositive `lambda`, the function always returns `NaN`', opts, function test( t ) {
	var y;
...
tape( 'the function returns `NaN` for `x >= lambda`', opts, function test( t ) {
	var y;
...
tape( 'the function evaluates the mgf for `x` given small `lambda` values', opts, function test( t ) {
	var expected;
	var lambda;
	var delta;
	var tol;
...
tape( 'the function evaluates the mgf for `x` given medium `lambda` values', opts, function test( t ) {
	var expected;
	var lambda;
	var delta;
	var tol;
...
tape( 'the function evaluates the mgf for `x` given large `lambda` values', opts, function test( t ) {
	var expected;
	var lambda;
	var delta;
	var tol;
